...
class HeteroSecureBoostingTreeTransferVariable(BaseTransferVariables):
    def __init__(self, flowid=0):
        ...
        self.encrypted_predict_F_init = self._create_variable(name='encrypted_predict_F_init', src=['guest'], dst=['host'])
        self.encrypted_predit_F_final = self._create_variable(name='encrypted_predit_F_final', src=['host'],
                                                              dst=['guest'])